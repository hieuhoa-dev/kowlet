      ...
      {tech !== null && (
        ...
        >
          <motion.div
            ...
            className="relative w-full max-w-2xl max-h-[80vh] rounded-2xl bg-background shadow-2xl overflow-hidden"
          >
            {/* Close Button */}
            <Button
              size="icon"
            ...
            <motion.div
              ...
              className="max-h-[55vh] overflow-y-auto p-6 space-y-4"
